<section class="footer-section my_fsect">
               ...
               <div class="col-md-12">
                  <div class="row">
                     <div class="col-md-3 col-sm-6">
                        ...
                        <a href="testimonials.php" class="email-link transition"><i></i><span></span>Our Clients</a>
                        <a href="testimonials.php" class="email-link transition"><i></i><span></span>Client Reviews</a>
              ...
              <div class="row">
                <div class="col-sm-2 col-md-2 col-xs-12">
                  <div class="footer-part1" id="footer-part1">
                      ...
                      <p>H 35 , Sector 63, <br> Noida, Uttar Pradesh<br> India - 201301 <br> +91-9717270746,<br> +91-120-4238296</p>
                      </center>
                  </div>
                </div>
                <div class="col-sm-2 col-md-2 col-xs-12">
                  <div class="footer-part1" id="footer-part1">
                          <center>
                          <img src="img/icons/kaaba.png">
                          <a href="mobile-app-development-company-in-india.html" tabindex="-1"><span><i class="fa fa-map-marker fa-1x" aria-hidden="true" style="color: #009afb;"></i></span> KSA</a>
                          <p>Riyadh, Al-Madina Rd.<br> Ali Ibn Shaiban St.,<br> Al-Awaly District. <br>Saudi Arabia <br> +966530392807</p>
                          </center>
                      </div>
                      </div>
                <div class="col-sm-2 col-md-2 col-xs-12">
                      <div class="footer-part1" id="footer-part1">
                          ...
                          <p>Al Yahar Street,<br>Al Khalidiya, Landmark Etisala Tower <br> Abu Dhabi - 33408 <br>+91-9717270746</p>
                          </center>
                      </div>
                      </div>
                <div class="col-sm-2 col-md-2 col-xs-12">                  
                      <div class="footer-part1" id="footer-part1">
                          ...
                          <p>426, Harrison ave,<br>New Jersey,<br> USA 07029 <br>+1-877-659-9068</p>
                          </center>
                      </div>
                      </div>
                <div class="col-sm-2 col-md-2 col-xs-12">
                ...
                <div class="col-sm-2 col-md-2 col-xs-12">
                      <div class="footer-part1" id="footer-part1">
                          <center>
                          <img src="img/icons/malaysia.png"> 
                          <br>
                          <a href="mobile-app-development-company-in-thailand.html" tabindex="-1"><span><i class="fa fa-map-marker fa-1x" aria-hidden="true" style="color: #009afb; padding: 5px;"></i></span>MALAYSIA</a>
               ...
               <div class="col-md-12">
                  ...
                  <p>Copyright &copy; 2018-2019 AppSquadz Technologies. All Rights Reserved. <a href="privacy-policy.html">Privacy Policy</a> | <a href="terms-conditions.html">Terms &amp; Conditions</a> | <a href="sitemap.html">Sitemap</a></p>
         ...
         <div class="row and_dev_foot">
              <div class="col-sm-3 col-md-3 sky_dev sl_appsqd">
                <p><a href=""><i class="fa fa-skype"></i><span> sales.appsquadz</span></a></p>
              </div>
              <div class="col-sm-3 col-md-3 sky_dev">
                <p><i class="fa fa-phone" aria-hidden="true"></i> <span> +91- 9717270746, +91- 9717866746</span></p>
              </div>              
              <div class="col-sm-3 col-md-3 so_icon">                
                 <div class="social-icon-block">
                     <div class="footerTitle" style="text-align: left;"></div>
                     <center>
                        <ul>
                           <li><a itemprop="sameAs" title="Facebook" target="_blank" href="https://www.facebook.com/appsquadz/" class="transition facebook" tabindex="-1"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                           <li><a itemprop="sameAs" title="Twitter" target="_blank" href="https://twitter.com/appsquadz" class="transition twitter" tabindex="-1"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                           <li><a itemprop="sameAs" title="Google Plus" target="_blank" href="https://plus.google.com/+AppSquadzTechnologiesPvtLtd" class="transition gplus" tabindex="-1"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
                           <li><a itemprop="sameAs" title="LinkedIn" target="_blank" href="https://www.linkedin.com/company/appsquadz" class="transition lin" tabindex="-1"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                           <li><a itemprop="sameAs" title="Youtube" target="_blank" href="https://www.youtube.com/c/AppSquadzTechnologiesPvtLtd" class="transition youtube" tabindex="-1"><i class="fa fa-play" aria-hidden="true"></i></a></li>
                           <li><a itemprop="sameAs" title="Instagram" target="_blank" href="https://www.instagram.com/appsquadz" class="transition instagram" tabindex="-1"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                           <li><a itemprop="sameAs" title="Behance" target="_blank" href="https://www.behance.net/AppSquadz" class="transition behance" tabindex="-1"><i class="fa fa-behance" aria-hidden="true"></i></a></li>
   ...
   $('.circle').on('click',function(){
     ...
     if( $('.mobile-country').length > 0 ) {
      ...
      function openRequestQuote(){
         ...
         $.ajax({
         type: "GET",
         url: "https://www.new.appsquadz.com/request-a-quote.php" , 
         data : { },
