...
<link rel="stylesheet" href="css/deva_sheesh.css">
<section class="main-banner-cover selected custom-banner index-banner" style="background:url(img/banners/home_banner_new.jpg) no-repeat center top; background-size: cover; background-size: 100% 116%;">
   <div class="container">
      <div class="mainsec new_mains">
         ...
         <div class="btn-section_work new_getan">
            <a href="portfolios.php" class="latest_work_btn headerestimate new_nce" target="_blank"><b>RECENT PROJECTS IN A GLANCE</b></a>
            <a href="app_price_calculator.html" class="latest_work_btn headerestimate" target="_blank"><b>Get an Estimate</b></a>
         </div>
      </div>
   </div>
...
<!---modale box-->
<!---end of modle box-->
<section class="pastPerformance new_mance" id="caseStudyLoadSection">
   <div class="container">
      <div class="fadeInUp animated3">
         <h3 style="font-size: 42px !important; color: #000;"><span>DEVELOPING APPLICATIONS | CURATING EXPERIENCES</span></h3>
      ...
      <div class="row">
         <div class="col-sm-4 zoomIn animated3 delay1">
            <div class="resultBlock new_block">
...
<section class="features-block of-hidden">
   <div class="container">
      <div class="main-content-block rows fadeInUp animated3 new_ideolo">
...
<section class="new_service_area">
        <div class="container-fluid new_gies">
            ...
            <div class="row">
                    ...
                    <div class="service_flipbox">
                        <div class="flipbox_font">
                            <div class="inner_flip">
                                <img src="image/new/mobile-application.png" alt="">
                                <h4>Mobile Applications &amp; Wearables</h4>
                                <p>Integrating various arenas for a connected future through iOS and Android applications.</p>
                            </div>
                        </div>
                        <div class="flipbox_back">
                            <div class="inner_flip">
                                <h4>Mobile Applications &amp; Wearables</h4>
                                <p>Integrating various arenas for a connected future through iOS and Android applications.</p>
                                <a href="http://www.new.appsquadz.com/mobile-application-development.html">Learn More</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="service_flipbox">
                        <div class="flipbox_font">
                            <div class="inner_flip">
                                <img src="image/new/Web_development.png" alt="">
                        ...
                        <div class="flipbox_back">
                            <div class="inner_flip">
                                <h4>Web Development</h4>
                                <p>We develop cult, full of potential and engaging websites for startups and enterprises which help them stand out from the crowd.</p>
                                <a href="http://www.new.appsquadz.com/web-development.html">Learn More</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="service_flipbox">
                        <div class="flipbox_font">
                            <div class="inner_flip">
                                <img src="image/new/online-shop.png" alt="">
                        ...
                        <div class="flipbox_back">
                            <div class="inner_flip">
                                <h4>E-commerce Development</h4>
                                <p>We help you develop and execute high profile yet affordable e-commerce services.</p>
                                <a href="http://www.new.appsquadz.com/ecommerce-web-development.html">Learn More</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="service_flipbox">
                        <div class="flipbox_font">
                            <div class="inner_flip">
                                <img src="image/new/cloud-computing.png" alt="">
                        ...
                        <div class="flipbox_back">
                            <div class="inner_flip">
                                <h4>Cloud Computing</h4>
                                <p>Having a prolific partnership with AWS, our experts provide optimised cloud solutions to migrate, manage and customise your cloud experience.</p>
                                <a href="http://www.new.appsquadz.com/cloud-application-development.html">Learn More</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="service_flipbox">
                        ...
                        <div class="flipbox_back">
                            <div class="inner_flip">
                                <h4>Offshore staffing</h4>
                                <p>We provide quality hiring and staffing solutions with a full-fledged hardware and software setup and progressive working environment.</p>
                                <a href="http://www.new.appsquadz.com/hire-dedicated-developer.html">Learn More</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="service_flipbox">
                        <div class="flipbox_font">
                            <div class="inner_flip">
                                <img src="image/new/Digital-marketing.png" alt="">
                        ...
                        <div class="flipbox_back">
                            <div class="inner_flip">
                                <h4>Digital Marketing Services</h4>
                                <p>We help brands optimise their Digital Marketing Performance. We offer a successful SEO service for our clients.</p>
                                <a href="http://www.new.appsquadz.com/seo-services.html">Learn More</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="mobile-features-tabing" id=leading-sec>
   <div class=leading-sec>
      <div class="in-banner-content-home1 fadeInUp animated3 new_aised" >
               ...
               <div class="container-fluid" >
                  <div class="row">
                     <div class="col-md-offset-2">
                        <h4 class="purpleText section-subtitle poppinsMediumBold margin-bottom20 blacktext new_aujala" id="proh">Udemy</h4>
                        ...
                        <p class="success-point whiteText blacktextsecondp new_edito">
         ...
         <div class="table">
            <div class="table-cell" style="background:#1866B1;">
               <div class="container-fluid" >
                  <div class="row">
                     <div class="col-md-offset-2">
                        <h4 class="purpleText section-subtitle poppinsMediumBold margin-bottom20 whitetext new_sure">Taxi For Sure</h4>
                        <p class="opensanseRegularFont text111 section-description margin-bottom20 " style="color:#fff; padding-right: 15px;">Appsquadz has developed the Taxi For Sure application which was the brainchild of Raghunandan G. It is a taxi service application for both drivers and passengers. The application did great business and was eventually bought out by OLA for $200 million.</p>
                        <a href="mobile-portfolio/aweza.html" class="pinkBg whiteText rounded-btn">App details</a>
                        <p class="success-point whiteText">
                           <span class="section-subtitle poppinsMediumFont new_edito">$40Million Funding</span>
         ...
         <div class="table">
            <div class="table-cell" >
               <div class="container-fluid">
                  <div class="row">
                     <div class="col-md-offset-2">
                        <h4 class="purpleText section-subtitle poppinsMediumBold margin-bottom20 blacktext new_aujala"><b>Amar Ujala</b></h4>
                        <p class="opensanseRegularFont text111 section-description margin-bottom20 blacktextp new_old">Amar Ujala is a household name in since the last 70 years. We helped Amar Ujala develop a mobile application to bring their offline content to people’s mobile phones globally and expand their viewership exponentially.</p>
                        <a href="case-studies/6-pack-promise-plus.html" class="pinkBg whiteText rounded-btn">App details</a>
                        <p class="success-point whiteText">
                           <span class="poppinsSemiboldFont font30 new_edito" style="color:#000;">Featured app</span>
                           <span class="section-subtitle poppinsMediumFont" style="color:#000;">on app store</span>
         ...
         <div class="table">
            <div class="table-cell" style="background:#1866B1;" >
               <div class="container-fluid">
                  <div class="row">
                     <div class="col-md-offset-2">
                        <h4 class="purpleText section-subtitle poppinsMediumBold margin-bottom20 whitetext new_aujala">Lazada</h4>
                        ...
                        <p class="success-point whiteText">
                           <span class="poppinsSemiboldFont font30 new_edito" >Featured app</span>
         ...
         <div class="table">
            <div class="table-cell">
               <div class="container-fluid">
                  <div class="row">
                     <div class="col-md-offset-2">
                        <h4 class="purpleText section-subtitle poppinsMediumBold margin-bottom20 blacktext new_aujala">Coca Cola</h4>
                        ...
                        <p class="success-point whiteText">
                           <span class="poppinsSemiboldFont font30 new_edito" style="color:#000;">Survey App</span>
                           <span class="section-subtitle poppinsMediumFont" style="color:#000;">on app store</span>
         ...
         <div class="table" style="margin-top: -28px;">
            <div class="table-cell" style="background:#1866B1;">
               <div class="container-fluid">
                  <div class="row">
                     <div class="col-md-offset-2">
                        <h4 class="purpleText section-subtitle poppinsMediumBold margin-bottom20 whitetext new_aujala">Chalklit</h4>
                        ...
                        <p class="success-point whiteText">
                           <span class="poppinsSemiboldFont font30 new_edito">$1.2Million Funding by Google</span>
...
<div class="container" style ="background :#fff">
   <div class="in-banner-content-home fadeInUp animated3 new_best" >
      <h1  style ="color :#000" >OUR CASE STUDIES</h1>
      <p  style ="color :#000">See how we’ve delivered best results to our smartest clients</p>
...
<section class="development-process-block">
   <div class="container">
      <div class="main-content-block rows fadeInUp animated3 new_ess">
   ...
   <div class="career-hiring" id="career-hiring">
      <div class="container">
         <div class="main-content-block pdT18">
            ...
            <div class="title-bar new_ors">A multi talented team of dedicated innovators</div>
...
<section class="home-portfolio-block">
   <div class="main-content-block fadeInUp animated3 new_ess">
...
<!-- footer section -->
<section id="pop-scroll" class="get-in-touch-section top-bofu new_footer hmf_new">
         <div class="container">
            <div class="from-block rows">
               <div class="col-md-12">
                  <div class="row">
                        ...
                        <div class="from-left-block rows">
                           ...
                           <div class="emailid-block block-emailid rows">
                              <a href="" class="transition">
                                <i class="fa fa-envelope"></i> <span class="small-text rows">mail to our sales department</span>
                           ...
                           <div class="emailid-block block-emailid voicemsg rows marT20">
                              <a href="skype:sales.appsquad?call" class="transition">
                                <i class="fa fa-skype"></i><span class="small-text rows">Our Skype Id</span> 
                                <span class="large-text rows" style=" font-size: 17px; line-height: 38px;">sales.appsquadz</span> </a>
                           </div>
                           <!-- <div class="emailid-block block-emailid voicemsg rows marT20">
                           ...
                           <div class="emailid-block block-emailid voicemsg rows marT20">
                              <a href="skype:sales.appsquadz?call" class="transition">
                                  <i class="fa fa-phone"></i><span class="small-text rows">Our Phone Number</span> 
                                  <span class="large-text rows" style=" font-size: 15px; line-height: 30px;">+91- 9717270746 (India) <br>+91- 9717866746(India) <br>+966530392807(KSA)<br>+91-9717270746(UAE)<br>+1-8776599068(USA)<br>+1-877-659-9068(UK)<br>+66-0946430863(Malaysia)</span> </a>
                           </div>
                     ...
                     <div class="col-md-7">
                        <div class="from-right-block rows new_homefm">
